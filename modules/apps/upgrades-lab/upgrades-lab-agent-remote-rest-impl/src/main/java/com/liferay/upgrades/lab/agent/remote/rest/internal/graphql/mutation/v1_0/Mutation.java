...
package com.liferay.upgrades.lab.agent.remote.rest.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	public boolean deleteUpgradeRunByExternalReferenceCode(
		...
		_applyVoidComponentServiceObjects(
			...
			upgradeRunResource ->
				upgradeRunResource.deleteUpgradeRunByExternalReferenceCode(
	...
	public UpgradeRun createUpgradeRun(
			@GraphQLName("upgradeRun") UpgradeRun upgradeRun)
		throws Exception {

		return _applyComponentServiceObjects(
			_upgradeRunResourceComponentServiceObjects,
			this::_populateResourceContext,
			upgradeRunResource -> upgradeRunResource.postUpgradeRun(
				upgradeRun));
	}
...
// LIFERAY-REST-BUILDER-HASH:-1351744593