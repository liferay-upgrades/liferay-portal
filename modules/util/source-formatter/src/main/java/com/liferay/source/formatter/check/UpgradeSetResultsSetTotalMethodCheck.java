...
public class UpgradeSetResultsSetTotalMethodCheck extends BaseUpgradeCheck {
	...
	private String _addTryCatch(
		String newContent, String methodCall, String stringBuilder) {
		...
		if (matcher.find()) {
			...
			String newLine = StringPool.NEW_LINE + StringPool.TAB;
			...
			sb.append(newLine);
			sb.append(tabs);
			sb.append("throw new PortalException(e);");
			sb.append(StringPool.NEW_LINE);
			sb.append(tabs);
	...
	private String _getNewMethodCall(
		...
		if ((setResultsMethodCall != null) && (setTotalMethodCall != null)) {
			return _addTryCatch(newContent, lastMethodCall, sb.toString());
		}
