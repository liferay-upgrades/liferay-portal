...
UpgradeGradlePetraModelAdapterCheck | .gradle | Removes the `com.liferay.petra.model.adapter` dependency from `build.gradle` since it is already bundled within the fat JAR. |
