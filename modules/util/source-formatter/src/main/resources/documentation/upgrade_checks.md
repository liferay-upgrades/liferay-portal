...
UpgradeJavaCTDisplayRendererGetContentCheck | .bnd, .ftl, .gradle, .java, .json, .jsp, .jspf, .scss, or .vm | Replace the `getContent` method with `renderPreview` in classes that extend `BaseCTDisplayRenderer`. |
